...
//http://localhost:1975/spring-crud-mybatis/
//http://localhost:1975/spring-crud-mybatis/employee/addEmployee
...
public class EmployeeJDBCController {
		...
		public String defaultMethod(ModelMap model){
			System.out.println("defualt Method invoked" );
		...
		public String testHttpSession(HttpSession session){
			...
			System.out.println("testHttpSession invoked counter from HttpSession"+ counter );
			return RETRIEVE_EMPLOYEE;
		}
		
		
		//http://localhost:1975/spring-crud-jdbc/employee/viewEmployee
		...
		//http://localhost:1975/spring-crud-jdbc/employee/addEmployee
		...
		//http://localhost:1975/spring-crud-jdbc/employee/updateEmployeeForm?empId=11
		...
		public String updateEmployeeForm(@ModelAttribute("employeevo")EmployeeVO employee,@RequestParam("empId") String empId,ModelMap model,HttpSession session) {
			...
			if(existingEmployee != null){
				...
				return RETRIEVE_EMPLOYEE+"?empId=0";
			}
		...
		//http://localhost:1975/spring-crud-jdbc/employee/retrieveEmployee?empId=11
		...
		public String updateEmployee(@ModelAttribute("employeevo")EmployeeVO employee,ModelMap model,HttpSession session) {
			...
			System.out.println("model.getAttribute(addEmployee) "
					+ model.get("addEmployee"));
			System.out.println("-- updateEmployee employee invoked"
					+ employee);
			...
			if(employee != null){
				...
				statusMessage = "Unable to find employee to update";
