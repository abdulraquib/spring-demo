...
<form:form action="/spring-crud-mybatis/employee/updateEmployee" method="POST" modelAttribute="employeevo">      
<table><tbody>
<tr>        
...
<tr>         
<td colspan="2"><input type="submit" value="UpdateEmployee">  </td>       </tr>
</tbody></table>
</form:form>
